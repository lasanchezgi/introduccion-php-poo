...
use TransporteInterfaz as GlobalTransporteInterfaz;
    ...
    class Automovil extends Transporte implements TransporteInterfaz {
        ...
        public function getInfo() : string {
            return "El transporte AUTO tiene " . $this->ruedas . " ruedas y una capacidad de " . $this->capacidad . " de personas y tiene el color " . $this->color;
        }
    ...
    echo "<pre>";
    var_dump($transporte = new Transporte(8,10));
